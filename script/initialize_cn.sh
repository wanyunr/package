...
# 下载并安装 lsd
wget -q --show-progress -P "$DOWNLOAD_DIR" https://js8.nl/https://github.com/lsd-rs/lsd/releases/download/v1.1.2/lsd_1.1.2_amd64_xz.deb
...
# 下载并安装 duf
wget -q --show-progress -P "$DOWNLOAD_DIR" https://js8.nl/https://github.com/muesli/duf/releases/download/v0.8.1/duf_0.8.1_linux_amd64.deb
...
# 下载并安装 fastfetch
wget -q --show-progress -P "$DOWNLOAD_DIR" https://js8.nl/https://github.com/fastfetch-cli/fastfetch/releases/latest/download/fastfetch-linux-amd64.deb
...
# 下载并安装 tcping
wget -q --show-progress -P "$DOWNLOAD_DIR" https://js8.nl/https://github.com/pouriyajamshidi/tcping/releases/latest/download/tcping_amd64.deb
